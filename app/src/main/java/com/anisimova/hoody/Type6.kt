...
class Type6 : AppCompatActivity(), ButtonsPaletteFragment.Callbacks {
    ...
    private lateinit var bodyRight: ImageView
    private lateinit var bodyLeft: ImageView
    ...
    private val hoodyType6ViewModel: HoodyTypeViewModel by lazy {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val requestPermissionLauncher = registerForActivityResult(ActivityResultContracts.RequestPermission()) { isGranted: Boolean ->
            if (isGranted) {
                hoodyType6ViewModel.saveHoody(fullHoody, this, "Hoody Design")
            } else { }
        }
        ...
        bodyRight = findViewById(R.id.bodyRight)
        bodyLeft = findViewById(R.id.bodyLeft)
        ...
        var partList: MutableList<View> = mutableListOf(
            ...
            bottomSleeveLeft,
            bottomBody)
        hoodyType6ViewModel.loadParts(partList)

        //работа кнопки очистить
        clearButton = findViewById(R.id.clear_btn)
        clearButton.setOnClickListener {
            hoodyType6ViewModel.clear()
        }
        ...
        saveButton.setOnClickListener {
            ...
            when {
                ContextCompat.checkSelfPermission(
                    ...
                    hoodyType6ViewModel.saveHoody(fullHoody, this, "Hoody-Woody")
    ...
    override fun onButtonClicked(color: List<Int>?)  {
        if(color != null) hoodyType6ViewModel.makeFilter(color)
    }
