...
class Type4 : AppCompatActivity(), ButtonsPaletteFragment.Callbacks {
    ...
    private val hoodyType4ViewModel: HoodyTypeViewModel by lazy {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val requestPermissionLauncher = registerForActivityResult(ActivityResultContracts.RequestPermission()) { isGranted: Boolean ->
            if (isGranted) {
                hoodyType4ViewModel.saveHoody(fullHoody, this, "Hoody Design")
            } else { }
        }
        ...
        var partList: MutableList<View> = mutableListOf(
            ...
            bottomBody,
            pocket)
        hoodyType4ViewModel.loadParts(partList)

        //работа кнопки очистить
        clearButton = findViewById(R.id.clear_btn)
        clearButton.setOnClickListener {
            hoodyType4ViewModel.clear()
        }
        ...
        saveButton.setOnClickListener {
            ...
            when {
                ContextCompat.checkSelfPermission(
                    ...
                    hoodyType4ViewModel.saveHoody(fullHoody, this, "Hoody-Woody")
    ...
    override fun onButtonClicked(color: List<Int>?)  {
        if(color != null) hoodyType4ViewModel.makeFilter(color)
