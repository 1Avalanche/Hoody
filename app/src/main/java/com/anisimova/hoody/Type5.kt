...
class Type5 : AppCompatActivity(), ButtonsPaletteFragment.Callbacks {
    ...
    private lateinit var sleeveRightLine: ImageView
    ...
    private lateinit var sleeveLeftLine: ImageView
    ...
    private val hoodyType5ViewModel: HoodyTypeViewModel by lazy {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val requestPermissionLauncher = registerForActivityResult(ActivityResultContracts.RequestPermission()) { isGranted: Boolean ->
            if (isGranted) {
                hoodyType5ViewModel.saveHoody(fullHoody, this, "Hoody Design")
            } else { }
        }
        ...
        sleeveRightLine= findViewById(R.id.sleeveRightLine)
        bodyLine = findViewById(R.id.bodyLine)
        sleeveLeftLine = findViewById(R.id.sleeveLeftLine)
        var partList: MutableList<View> = mutableListOf(
                ...
                bottomSleeveLeft,
                bottomBody)
        hoodyType5ViewModel.loadParts(partList)

        //работа кнопки очистить
        clearButton = findViewById(R.id.clear_btn)
        clearButton.setOnClickListener {
            hoodyType5ViewModel.clear()
        }
        ...
        saveButton.setOnClickListener {
            ...
            when {
                ContextCompat.checkSelfPermission(
                    ...
                    hoodyType5ViewModel.saveHoody(fullHoody, this, "Hoody-Woody")
    ...
    override fun onButtonClicked(color: List<Int>?)  {
        if(color != null) hoodyType5ViewModel.makeFilter(color)
