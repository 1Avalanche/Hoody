...
class FragmentType4 : Fragment(), Callbacks {
    ...
    private lateinit var bodyBottom: ImageView
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_type4, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bodyBottom = view.findViewById(R.id.body_bottom)
