...
class Type3 : AppCompatActivity(), ButtonsPaletteFragment.Callbacks {
    ...
    private val hoodyType3ViewModel: HoodyTypeViewModel by lazy {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val requestPermissionLauncher = registerForActivityResult(ActivityResultContracts.RequestPermission()) { isGranted: Boolean ->
            if (isGranted) {
                hoodyType3ViewModel.saveHoody(fullHoody, this, "Hoody Design")
            } else { }
        }
        ...
        var partList: MutableList<View> = mutableListOf(
                ...
                bottomBody,
                pocket)
        hoodyType3ViewModel.loadParts(partList)

        //работа кнопки очистить
        clearButton = findViewById(R.id.clear_btn)
        clearButton.setOnClickListener {
            hoodyType3ViewModel.clear()
        }
        ...
        saveButton.setOnClickListener {
            ...
            when {
                ContextCompat.checkSelfPermission(
                    ...
                    hoodyType3ViewModel.saveHoody(fullHoody, this, "Hoody-Woody")
    ...
    override fun onButtonClicked(color: List<Int>?)  {
        if(color != null) hoodyType3ViewModel.makeFilter(color)
